...
exports_files(["WORKSPACE"], visibility = ["//visibility:public"])
""",
    sha256 = "d402e322841abc3c5c8b0352f08d54d6b5c25b7d6f81716401da266bcb1d1ff0",
    strip_prefix = "jdk-15.0.1+9",
    urls = ["https://github.com/AdoptOpenJDK/openjdk15-binaries/releases/download/jdk-15.0.1%2B9/OpenJDK15U-jdk_s390x_linux_hotspot_15.0.1_9.tar.gz"],
)
